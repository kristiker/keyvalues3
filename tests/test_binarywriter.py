...
class TestBinaryV1UncompressedWriter(unittest.TestCase):
    ...
    def test_write_match_expected(self):
        kv3_obj = KV3File({"A": 1})
        expect = b'VKV\x03\x00\x05\x86\x1b\xd8\xf7\xc1@\xad\x82u\xa4\x82g\xe7\x14t\x12\x16|\x06\xe9F\x98\xaf\xf2\xe6>\xb5\x907\xe7\x01\x00\x00\x00A\x00\t\x01\x00\x00\x00\x00\x00\x00\x00\x10'
        with io.BytesIO() as file:
