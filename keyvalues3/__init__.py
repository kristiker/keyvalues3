...
def read(text_stream: typing.TextIO) -> KV3File:
    """Reads a text KV3 file from a stream."""
@typing.overload
def read(binary_stream: typing.BinaryIO) -> KV3File:
    """Reads a binary KV3 file from a stream."""
@typing.overload
def read(path: str | os.PathLike) -> KV3File:
    """Reads a binary or text KV3 file from a path."""

def read(path_or_stream) -> KV3File:
    ...
    def read_binary(binary_stream: typing.BinaryIO):
        ...
        elif magic == BinaryMagics.VKV3.value:
            ...
        raise ValueError("Unknown binary KV3 magic: " + str(magic))
