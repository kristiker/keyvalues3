...
ENCODING_BINARY_UNCOMPRESSED = Encoding(
    "binary", UUID("1b860500-f7d8-40c1-ad82-75a48267e714")
)
ENCODING_BINARY_BLOCK_COMPRESSED = Encoding(
    "binarybc", UUID("95791a46-95bc-4f6c-a70b-05bca1b7dfd2")
)
ENCODING_BINARY_BLOCK_LZ4 = Format(
    "binarylz4", UUID("6847348a-63a1-4f5c-a197-53806fd9b119")
)
...
class flagged_value:
    ...
    def __init__(self, value: ValueType, flags: Flag = Flag(0)):
        ...
        assert (
            isinstance(value, flagged_value) == False
        ), "value should not be already flagged"
        self.value = value
        self.flags = flags
